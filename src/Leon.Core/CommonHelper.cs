...
using System.Web;
using Leon.Core.Exceptions;
using Leon.Core.ComponentModel;
...
namespace Leon.Core
{
    ...
    public partial class CommonHelper
    {
        ...
        //    if (pi == null)
        //        throw new LeonException("No property '{0}' found on the instance of type '{1}'.", propertyName, instanceType);
        //    if (!pi.CanWrite)
        //        throw new LeonException("The property '{0}' on the instance of type '{1}' does not have a setter.", propertyName, instanceType);
